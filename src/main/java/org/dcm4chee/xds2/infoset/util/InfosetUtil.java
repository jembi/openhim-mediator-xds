...
public class InfosetUtil {
    ...
    private static ObjectFactory objFacRim = new ObjectFactory();
    private static oasis.names.tc.ebxml_regrep.xsd.query._3.ObjectFactory objFacQuery = new oasis.names.tc.ebxml_regrep.xsd.query._3.ObjectFactory();
    ...
    public static void addOrOverwriteSlot(RegistryObjectType ro, Map<String, SlotType1> slots, String slotName, String... val) throws JAXBException {
        ...
        SlotType1 slot = objFacRim.createSlotType1();
        slot.setName(slotName);
        ValueListType valueList = objFacRim.createValueListType();
    ...
    public static AdhocQueryResponse emptyAdhocQueryResponse() {
        AdhocQueryResponse rsp = objFacQuery.createAdhocQueryResponse();
        rsp.setRegistryObjectList(objFacRim.createRegistryObjectListType());
        return rsp;
    }
