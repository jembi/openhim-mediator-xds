...
public class ParseRegistryStoredQueryActorTest {
    ...
    public void testParseValidRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            ...
            ParsedRegistryStoredQuery result = expectMsgClass(Duration.create(2000, TimeUnit.MILLISECONDS), ParsedRegistryStoredQuery.class);
    ...
    public void testParseInvalidRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            ...
            FinishRequest result = expectMsgClass(Duration.create(2000, TimeUnit.MILLISECONDS), FinishRequest.class);
